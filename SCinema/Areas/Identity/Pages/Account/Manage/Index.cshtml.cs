...
namespace SCinema.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            // Champ personnalisé (différent de Identity PhoneNumber)
            [Display(Name = "Téléphone")]
            public string Phone { get; set; }

            // (Facultatif) si tu veux aussi gérer le PhoneNumber natif d’Identity
            [Phone]
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            var phoneNumberIdentity = await _userManager.GetPhoneNumberAsync(user);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // (Facultatif) synchroniser aussi le PhoneNumber d’Identity
